...
public class Clouds extends BaseEntity {
	private static final String TAG = Cloud.class.getName();
    private float length;
    private Array<TextureRegion> regClouds;
    private Array<Cloud> clouds;

    private class Cloud extends BaseEntity {
...
//        	Gdx.app.log(TAG, "cloud x:"+position.x+" y:"+position.y);
        }
    }
    ...
    private void init() {
        ...
        regClouds.add(new TextureRegion(new Texture(Gdx.files.internal("level/cloud01.png"))));
        regClouds.add(new TextureRegion(new Texture(Gdx.files.internal("level/cloud02.png"))));
        regClouds.add(new TextureRegion(new Texture(Gdx.files.internal("level/cloud03.png"))));
        int distFac = 5;
    ...
    public void update(float deltaTime) {
        for (int i = clouds.size - 1; i >= 0; i--) {
            ...
            if (cloud.position.x < -Constants.CAMERA_WIDTH/2-length) {
